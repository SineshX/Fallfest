...
class WelcomePage {
	...
	JLabel welcomeLabel2=new JLabel("ALLEVIATE AID ADVISORY");
	private JButton jButton1;//REGISTER 
    private JButton jButton2;// LOG IN 
...
class AllUser {
    ...
    static String user, pass1, name, phone, pass2, email,age ,sex ;
...
class Application implements I1         //class for applications for portal 
{
  ...
  public void PatientHelp()
  {
	...
	{	 
		  ...
		  {
			  int c;
			  BufferedReader file1=new BufferedReader(new FileReader("E:/Team15/Head Related.txt"));
			  while((c=file1.read())!=-1)
			  {
				  System.out.print((char)c);
			  }
		  ...
		  if(a==1)
		  {
			  ...
			  {
				  int c;
				  BufferedReader file1=new BufferedReader(new FileReader("E:/Team15/Head type1.txt"));
				  while((c=file1.read())!=-1)
				  {
					  System.out.print((char)c);
		  ...
		  else if(a==2)
		  {
			  ...
			  {
				  int c;
				  BufferedReader Tfile2=new BufferedReader(new FileReader("E:/Team15/Head Type2.txt"));
				  while((c=Tfile2.read())!=-1)
				  {
					  System.out.print((char)c);
				  }
		  ...
		  else if(a==3)
		  {
			  ...
			  {
				  int c;
				  BufferedReader Tfile2=new BufferedReader(new FileReader("E:/Team15/HEAD TYPE3.txt"));
				  while((c=Tfile2.read())!=-1)
				  {
					  System.out.print((char)c);
				  }
		  ...
		  else if(a==4)
		  {
			  ...
			  {
				  int c;
				  BufferedReader Tfile2=new BufferedReader(new FileReader("E:/Team15/HEAD TYPE4.txt"));
				  while((c=Tfile2.read())!=-1)
				  {
					  System.out.print((char)c);
				  }
		  ...
		  else if(a==5)
		  {
			  ...
			  {
				  int c;
				  BufferedReader Tfile2=new BufferedReader(new FileReader("E:/Team15/HEAD TYPE5.txt"));
				  while((c=Tfile2.read())!=-1)
				  {
					  System.out.print((char)c);
				  }
